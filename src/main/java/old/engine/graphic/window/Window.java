package old.engine.graphic.window;

import java.io.Closeable;
import java.nio.IntBuffer;

import old.engine.io.inputs.WindowListener;
import org.lwjgl.glfw.GLFW;
import org.lwjgl.glfw.GLFWVidMode;
import org.lwjgl.opengl.GL;
import org.lwjgl.system.MemoryStack;

import old.engine.io.inputs.KeyListener;
import old.engine.io.inputs.MouseListener;
...
public final class Window implements AutoCloseable { // TODO: make AbstractWindow?
    ...
    private final static int DEFAULT_WIDTH = 300, DEFAULT_HEIGHT = 200;
    ...
    private static void create() {
        ...
        // Crear la ventana
        get().glfwWindow = glfwCreateWindow(DEFAULT_WIDTH, DEFAULT_HEIGHT, DEFAULT_TITLE, NULL, NULL);
        ...
        glfwSetKeyCallback(get().glfwWindow, KeyListener::keyCallback); // Teclado
    ...
    public static Window withWidth(int width) {
        glfwSetWindowSize(glfwWindow(), width, WindowListener.getHeight());
        return get();
    ...
    public static Window withHeight(int height) {
        glfwSetWindowSize(glfwWindow(), WindowListener.getWidth(), height);
        return get();
    }
    ...
    public static Window withPositionX(int positionX) {
        glfwSetWindowPos(glfwWindow(), positionX, WindowListener.getPosY());
        return get();
    }
